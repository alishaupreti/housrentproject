...
<?php
include ('view/review-engine.php');
include('view/booking-engine.php');
...
<div style="margin-top:3%" class="container-fluid">
  <div class="row">
  <h1 style="color:maroon;text-transform:uppercase;font-size:35px;text-align:center;"> Property Details </h1>
    <div style="margin-top:3%"class="col-sm-6">
...
<div id="myCarousel" class="carousel slide" data-ride="carousel">
  ...
  <div class="item active">
      <img class="d-block img-fluid" src="<?php echo $base_url ?>admin-zone/<?php echo $photo ?>" alt="First slide" width="100%" style="max-height: 600px; min-height: 600px;">
    </div>
  <?php 
  }
  else
...
<div style="margin-top:3%"class="col-sm-6">
  <center><h2 style="font-size:25px !important;font-weight:600px"><?php echo $rows['property_type'] ?></h2></center><br><br>
          <table style="border:1px solid maroon;padding:15px">
            <tr style="border:1px solid maroon">
              <td><h3><b>Province:</b></h3></td>
              <td><h4><?php echo $rows['province']; ?></h4></td>
            </tr>
            <tr style="border:1px solid maroon">
              <td><h3><b>Zone:</b></h3></td>
            ...
            <tr style="border:1px solid maroon">
              <td><h3><b>VDC/Municipality:</b></h3></td>
              <td><h4><?php echo $rows['vdc_municipality']; ?></h4></td>
            </tr>
            <tr style="border:1px solid maroon">
              <td><h3><b>Ward No.:</b></h3></td>
              <td><h4><?php echo $rows['ward_no']; ?></h4></td>
            </tr>
            <tr style="border:1px solid maroon">
              <td><h3><b>Tole:</b></h3></td>
              <td><h4><?php echo $rows['area_tole']; ?></h4></td>
            </tr>
            <tr style="border:1px solid maroon">
            ...
            <tr style="border:1px solid maroon">
              <td><h3><b>Estimated Price:</b></h3></td>
              <td><h4>Rs.<?php echo $rows['estimated_price']; ?></h4></td>
            </tr>
          </table>
          <table style="border:1px solid maroon;padding:15px">
            <tr style="border:1px solid maroon;padding:15px">
              <td><h3><b>Total Rooms:</b></h3></td>
              <td><h4><?php echo $rows['total_rooms']; ?></h4></td>
            </tr>
            <tr style="border:1px solid maroon;padding:15px">
              <td><h3><b>Bedrooms:</b></h3></td>
              <td><h4><?php echo $rows['bedroom']; ?></h4></td>
            </tr>
            <tr style="border:1px solid maroon;padding:15px">
              <td><h3><b>Living Room:</b></h3></td>
              <td><h4><?php echo $rows['living_room']; ?></h4></td>
            </tr>
            <tr style="border:1px solid maroon;padding:15px">
              <td><h3><b>Kitchen:</b></h3></td>
              <td><h4><?php echo $rows['kitchen']; ?></h4></td>
            </tr>
            <tr style="border:1px solid maroon;padding:15px">
              <td><h3><b>Bathroom:</b></h3></td>
              <td><h4><?php echo $rows['bathroom']; ?></h4></td>
            </tr>
            <tr style="border:1px solid maroon;padding:15px">
              <td><h3><b>Booked:</b></h3></td>
...
<form method="POST" action="<?php echo $base_url?>?r=chatpage">
...
<div style="margin-top:4%"class="col-md-12">
...
<?php }} ?>
  ...
  <h2 style="font-size:25px !important;color:maroon;font-weight:600">Review Property:</h2>
...
echo '<div class="container-fluid">';
    echo '<h3 style="font-weight:500;font-size:15px;">Reviews:</h3>';
    echo '</div>';
  if(mysqli_num_rows($query)>0)
    
{
    while($row=mysqli_fetch_assoc($query)){
      ...
      <div class="container-fluid">        
        <ul><li style="font-size:15px;"><?php echo $row['comment']; ?> &nbsp;&nbsp;&nbsp;(<span class="glyphicon glyphicon-star-empty" style="size: 50px;"><?php echo $row['rating']; ?></span>)</li></ul>
      </div>
  ...
  var y=document.getElementById("lon").innerText ;
   var latlng = new google.maps.LatLng(x,y);
    ...
    google.maps.event.addListener(marker, 'click', function() {
      ...
      '<div class="iw_title"><b>Location</b> : Nepal</div></div>';
